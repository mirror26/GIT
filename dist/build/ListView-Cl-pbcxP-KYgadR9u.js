import{u as A,h as oe,a4 as ge,gc as j,gd as fe,eE as J,ge as xe,j as e,F as x,U as S,aH as N,a0 as ye,D as se,E as ie,aV as be,L as ae,r as L,B as m,d as h,a5 as je,n as Ce,dz as we,w as X,x as _,y as P,z,T as f,A as G,C as Q,br as Y,bs as ee,aL as Te,I as te,aK as ve,bz as ke,bk as $e}from"./strapi-B6GNPAXK.js";import{u as D,a as re,g as u,A as Me,C as ne}from"./index-Knq4Ti8R-rbVSYlpw.js";import"./sortBy-COCxNQFA.js";import"./groupBy-0WP1oK3N.js";import"./_baseEach-a3mzux5I.js";import"./index-BWi31ABZ.js";import"./index-BRVyLNfZ.js";import"./_arrayIncludesWith-BNzMLSv9.js";import"./_baseMap-BNKYKfK1.js";const Fe=h(m)`
  table {
    width: 100%;
    white-space: nowrap;
  }
...
`,De=({component:t,dzName:n,index:o,isActive:s=!1,isInDevelopmentMode:r=!1,onClick:i})=>{const{modifiedData:p,removeComponentFromDynamicZone:b}=D(),{schema:{icon:y,displayName:g}}=j(p,["components",t],{schema:{}}),l=a=>{a.stopPropagation(),b(n,o)};return e.jsxs(Ae,{alignItems:"center",direction:"column",className:s?"active":"",borderRadius:"borderRadius",justifyContent:"center",paddingLeft:4,paddingRight:4,shrink:0,onClick:i,role:"tab",tabIndex:s?0:-1,cursor:"pointer","aria-selected":s,"aria-controls":`dz-${n}-panel-${o}`,id:`dz-${n}-tab-${o}`,children:[e.jsx(Ie,{icon:y,isActive:s}),e.jsx(m,{marginTop:1,maxWidth:"100%",children:e.jsx(f,{variant:"pi",fontWeight:"bold",ellipsis:!0,children:g})}),r&&e.jsx(ce,{tag:"button",onClick:l,children:e.jsx($e,{})})]})},Re=h(N)`
  width: 3.2rem;
  height: 3.2rem;
  padding: 0.9rem;
